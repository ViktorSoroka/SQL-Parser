define (require) ->
  ...
  describe "parserCore", ->
    ...
    describe 'seq', ->
      ...
      it "should return undefined if at least one parser cant`t parse ", ->
...
#    it "should throw error if parameter is not a function", ->
#      expect( -> new parser.Pattern 3).toThrow(new Error("Parsing is not a function"))